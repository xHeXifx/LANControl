...
gist_id = "f8291a771e19ae6fca1107a4657fc70e"
...
def copynew():
    ...
    newapppy = os.path.join(tmp_dir, "main.py")
    newVERSION = os.path.join(tmp_dir, 'VERSION')

    print("Copying new main.py and VERSION from tmp")
...
if __name__ == '__main__':
    ...
    if latestVersion > currentVersion:
        print("LANControl can be updated!")
